...
import { appgreen, EV_CAR_BRANDS, whiteText } from '../../constants';
...
//         longitudeDelta: 0.1
//       });
//       planRoute(userLocation, destination);
//     }
//   }, [route.params?.destination, userLocation]);
...
//     // Type guard to check if item is PlaceSuggestion
//     if ('structured_formatting' in item) {
//       const placeId = item.place_id;
//       const coords = await fetchPlaceDetails(placeId);
//       if (!coords) {
...
//   const planRoute = async (origin: Coordinates, destination: Coordinates) => {
//     if (!userLocation) {
//       Alert.alert('Error', 'User location not set.');
//       return;
//     }
...
//       const coordinates: Coordinates[] = routeData.legs[0].steps.map(
//         (step) => ({
//           latitude: step.start_location.latitude,
//           longitude: step.start_location.longitude
//         })
...
//       setRouteData({ coordinates, distance, duration, chargingStops });
...
//     >
//       <Icon
//         name={'description' in item ? 'history' : 'place'}
//         size={20}
//         color='#666'
//         style={styles.suggestionIcon}
//       />
